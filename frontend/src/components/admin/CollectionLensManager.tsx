...
interface CollectionLensManagerProps {
  collectionId: number;
  initialLenses: LensItem[];
}

export default function CollectionLensManager({
  collectionId,
  initialLenses,
}: CollectionLensManagerProps) {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      {currentLenses.length === 0 ? (
        <p className="text-sm text-zinc-400">No lenses in this collection yet.</p>
      ) : (
