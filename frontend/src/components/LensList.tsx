      ...
      {items.length > 0 ? (
        ...
        <Table className="table-fixed">
          <TableHeader>
            <TableRow>
              {[
                { key: "name", label: "Name", className: "w-[25.5%]" },
                { key: "brand", label: "Brand", className: showSeries ? "w-[9.5%]" : "w-[11%]" },
                { key: "system", label: "System", className: showSeries ? "w-[10%]" : "w-[14%]" },
                { key: "focalLength", label: "Focal Length", className: "w-[10.5%] text-right" },
