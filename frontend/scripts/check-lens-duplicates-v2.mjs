...
function aggressiveNorm(name) {
  return name
    ...
    .replace(/^asahi (super-multi-coated |super-)?takumar/, 'pentax')
    .replace(/^asahi (pentax|opt\.)/, 'pentax')
    .replace(/^smc pentax/, 'pentax')
    .replace(/^hd pentax/, 'pentax')
    .replace(/^nippon kogaku/, 'nikon')
    .replace(/^nikkorex/, 'nikon')
    .replace(/^nikkor/, 'nikon')
    .replace(/^fujinon/, 'fuji')
    .replace(/^fujifilm fujinon/, 'fuji')
    .replace(/^fujifilm super ebc fujinon/, 'fuji')
    .replace(/^fujifilm/, 'fuji')
    .replace(/^fujica/, 'fuji')
    .replace(/^mamiya[/-]sekor/, 'mamiya')
    .replace(/^(rolleinar|zoom-rolleinar|reflex-rolleinar|hft-rolleinar|f-rolleinar|apo-rolleinar|rollei-hft)/, 'rollei')
    .replace(/^komuranon/, 'komura')
    .replace(/^komura-fx/, 'komura')
    .replace(/^exaktar/, 'exakta')
    .replace(/^tamron-f/, 'tamron')
